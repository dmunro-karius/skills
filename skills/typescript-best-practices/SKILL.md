...
Make the type system carry the invariants: shapes where the illegal value can't be built, validation at the boundary, and no escape hatches inside.
...
| Boundary validation | Validate once where data crosses in; trust types inside. Don't re-validate deep in call chains. |
...
Adapted from [cursor/plugins](https://github.com/cursor/plugins/tree/main/pstack/skills/typescript-best-practices).
